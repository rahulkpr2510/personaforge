...
export default async function AdminAnalysisDetailPage({ params }: PageParams) {
	...
	return (
		<div className="space-y-8">
			...
			{/* ── Owner banner ── */}
			<div className="flex items-center gap-3 rounded-2xl border border-(--pf-amber)/25 bg-(--pf-amber-soft) px-5 py-3.5">
				<div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-(--pf-amber)/30 bg-background">
					<UserCircle className="h-5 w-5 text-(--pf-amber)" />
				</div>
				<div className="flex-1 min-w-0">
					<p className="text-[10px] font-semibold uppercase tracking-widest text-(--pf-amber)">
						Analysis Owner
					</p>
					...
					<div className="mb-4 flex items-center justify-between">
						<div>
							...
							<p className="text-xs text-muted-foreground mt-0.5">
								Each persona independently evaluated this product — expand for
								their full report
							</p>
						</div>
			...
			{analysis.pages.length > 0 && (
				<div>
					<div className="mb-4">
						...
						<p className="text-xs text-muted-foreground mt-0.5">
							Every page visited, with individual friction scores
						</p>
					</div>
					<div className="rounded-2xl border border-border bg-card overflow-hidden">
