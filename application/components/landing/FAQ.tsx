...
const faqSpring = { type: "spring" as const, stiffness: 240, damping: 28 };
const bouncySpring = { type: "spring" as const, stiffness: 320, damping: 16 };
	...
	return (
        ...
        ${
					open
						...
						: "border border-dashed border-transparent border-b-neutral-200 dark:border-b-neutral-800 bg-transparent py-4 px-2 hover:bg-neutral-50/40 dark:hover:bg-neutral-900/20"
				}
      `}
		>
			{/* Trigger row */}
			...
			>
				<motion.span
					animate={{ x: open ? 8 : 0 }}
					whileHover={{ x: open ? 8 : 4 }}
					transition={bouncySpring}
					className="font-heading text-sm font-semibold text-neutral-900 dark:text-neutral-100 leading-snug"
				>
					{q}
				</motion.span>
				<motion.div
				...
				{open && (
					...
					>
						<motion.p
							animate={{ x: open ? 8 : 0 }}
							transition={bouncySpring}
							className="font-body text-xs sm:text-sm text-neutral-500 dark:text-neutral-400 leading-relaxed"
						>
							{a}
						</motion.p>
					</motion.div>
...
export function FAQ() {
	return (
		<section
			id="faq"
			className="relative w-full py-28 px-4 bg-background border-t border-neutral-100 dark:border-neutral-900 overflow-hidden"
		>
			...
			<div className="relative mx-auto max-w-3xl">
				...
				>
					...
					<p className="mt-4 font-body text-[15px] text-neutral-500 dark:text-neutral-400 max-w-lg mx-auto leading-relaxed">
						Everything you need to know about PersonaForge and synthetic user
						research.
					</p>
				</motion.div>
