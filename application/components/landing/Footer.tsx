...
const SOCIAL_LINKS = [
  ...
  {
    label: "GitHub",
    href: "https://github.com/rahulkpr2510/personaforge",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4">
...
function FooterLink({ text, href }: { text: string; href: string }) {
  ...
  const className = "font-body text-xs sm:text-sm text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white transition-colors duration-200";
...
export function Footer() {
  return (
    <footer id="contact" className="relative border-t border-neutral-100 dark:border-neutral-900 bg-background overflow-hidden">
      {/* Noise overlay */}
      <NoiseTexture />
      ...
      <div className="mx-auto max-w-5xl px-4 py-16 relative z-10">
        ...
        <div className="mb-8 flex flex-col items-center gap-2">
          <div className="flex items-center gap-2">
            <span
              className="flex h-7 w-7 items-center justify-center rounded-lg bg-neutral-900 dark:bg-neutral-50 text-white dark:text-black text-xs font-black"
            >
              P
            </span>
            <span
